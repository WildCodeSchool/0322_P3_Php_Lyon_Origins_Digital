 ...
 */
final class Version20230624132013 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_video_likes (user_id INT NOT NULL, video_id INT NOT NULL, INDEX IDX_6FB38E4AA76ED395 (user_id), INDEX IDX_6FB38E4A29C1004E (video_id), PRIMARY KEY(user_id, video_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
